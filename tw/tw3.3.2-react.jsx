...
const Sidebar= (await getModule(`/src/reactjs/${X}sidebarPresenter.jsx`))?.Sidebar;
const Summary= (await getModule(`/src/reactjs/${X}summaryPresenter.jsx`))?.Summary;

function getDishDetails(x){ return dishesConst.find(function(d){ return d.id===x;});}

const preamble=<div>
                 <p>This is the TW3.3 React Component State, Lifecycle and Observer interactive test, featuring Sidebar and Summary presenters</p>

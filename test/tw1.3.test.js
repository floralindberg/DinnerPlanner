...
describe("TW1.3 Array Rendering and basic CSS", function tw1_3() {
    ...
    testComponent(
        ...
        "SummaryView table content (render table rows to enable) [test UI with Vue](/tw1.3.1.html)[or React](/tw1.3.1-react.html)",
        function tw1_3_1(output, propIndex,_, test){
            ...
            if(!tableRows.length)
                test.skip();
            test._runnable.title=  "SummaryView table content [test UI with Vue](/tw1.3.1.html)[or React](/tw1.3.1-react.html)";
    ...
    testComponent(
        ...
        [{people:3, ingredients:dishesConst.ingrList1},
         {people:2, ingredients:dishesConst.ingrList2}],
        "SummaryView table order (render table rows to enable) [test UI with Vue](/tw1.3.1.html)[or React](/tw1.3.1-react.html)",
        function tw1_3_2(output, propIndex , _, test){
            const rows1= output.queryAllByRole('row');
            const [x,...tableRows] = rows1;
            if(!x)
                test.skip();
            test._runnable.title=         "SummaryView table order [test UI with Vue](/tw1.3.1.html)[or React](/tw1.3.1-react.html)";
    ...
    testComponent({vue: SidebarView},
        ...
        "SidebarView table content [test UI with Vue](/tw1.3.2.html)[or React](/tw1.3.2-react.html)",
    ...
    testComponent({vue: SidebarView},
        ...
        "SidebarView table order [test UI with Vue](/tw1.3.2.html)[or React](/tw1.3.2-react.html)",

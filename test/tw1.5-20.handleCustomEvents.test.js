...
describe("TW1.5 Presenter handles custom events and changes Model [test Vue](/tw1.5.2.html)[React](/tw1.5.2-react.html)", function tw1_5_20() {
    ...
    testComponent({
        ...
        expect(lastRemovedDish?.title,"custom event handler "+remove+" should remove a dish").to.equal(dishesConst.dishes3[1].title);
        expect(`id: ${lastRemovedDish?.id}`,"custom event handler "+remove+" should remove a dish").to.equal(`id: ${dishesConst.dishes3[1].id}`);

...
describe("TW3.3.2 Navigation buttons in views [Vue](/vue.html) [React](/react.html)", function tw_3_3_2() {
    this.timeout(200000);
    ...
    it("SummaryView should have a button leading to search (render a button in SummaryView to enable)",  async function  tw_3_3_2_1() {
    ...
    it("DetaillsView should have a button leading to search without adding the dish",  async function  tw_3_3_2_2() {
        installOwnCreateElement();
    ...
    it("DetaillsView dish adding button should lead to search",  async function  tw_3_3_2_3() {
    ...
    it("SidebarView dish view links should open dish details",  async function  tw_3_3_2_4() {
        installOwnCreateElement();
    ...
    it("SearchResultsView dish click should lead to details",  async function  tw_3_3_2_5() {
        const {clickables, rendering}= prepareViewWithCustomEvents(
            SearchResultsView,
            {searchResults},
        ...
        await Promise.all(clickables.map(async function  tw_3_3_2_5_loop(clickable){
       ...
       it("SearchFormView button click should lead to Summary",  async function  tw_3_3_2_5() {
        installOwnCreateElement();
